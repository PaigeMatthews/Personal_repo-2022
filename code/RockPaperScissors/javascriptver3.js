...
function playRound(event) {
  ...
  result.innerHTML = `You played ${playerSelection}, the house played ${houseSelection}. ${outcome}`; //displaying the outcome to the screen
...
function getOutcome(player, house) { //stating how the scoring system works
  if (player === house) {
    return "It's a tie!";
  } else if (
